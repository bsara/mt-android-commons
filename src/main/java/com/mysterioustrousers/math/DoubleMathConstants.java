package com.mysterioustrousers.math;
...
public class DoubleMathConstants {
  ...
  public static final double PI_OVER_4 = ((double)Math.PI / (double)4.0);
  public static final double PI_OVER_6 = ((double)Math.PI / (double)6.0);
}